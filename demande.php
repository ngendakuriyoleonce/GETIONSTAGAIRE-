...
$msg="";
if (isset($_POST['add'])) {
    if ($_POST['Service']!="" AND $_POST['Debut']!="" AND $_POST['description']!="") {
    ...
    mysqli_query($con,"INSERT INTO stages(Service,FromDate,ToDate,Description,Status,IsRead,IdStagaire) VALUES('$Service','$Debit','$Fin','$description','$status','$isread','$empid')");
                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1><strong>Demande</strong> Stage </h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Nouveau Demande Stage</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
