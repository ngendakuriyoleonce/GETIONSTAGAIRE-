...
{
$close=$_GET['idstage'];
mysqli_query($con,"delete from  stages  WHERE IdStage='$close'");
}
?>
<!doctype html>
                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1><strong>Historique</strong> Stages</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Historique  Stages</strong>
                            </div>
                            <div class="card-body">
                                ...
                                $res=mysqli_query($con,"SELECT * from  stages inner join tbldepartments on stages.Service= tbldepartments.IdDep where stages.IdStagaire='$lid' order by IdStage desc");
                            $cnt=1;
                         ...
                         while ($row=mysqli_fetch_assoc($res)) {
                                       ...
                                       ?>   
                                                ...
                                                <span style="color: red">Refusé</span>
                                                 ...
                                                 <a href="history.php?idstage=<?php echo $row['IdStage'] ?>" onclick="return confirm('Are you sure you want to Close this applied internship?');"><i class="ti ti-close" style="color: red"></i></a>
                                                        <?php } ?></td>                           
