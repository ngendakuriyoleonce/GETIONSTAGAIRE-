                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title"><strong>Stages</strong> Termines </h4>
                                </div>
                                <div class="card-body--">
