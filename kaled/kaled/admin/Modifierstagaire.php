...
if (isset($_POST['modemp'])) {
    ...
    mysqli_query($con,"update stagaires set FirstName='$nom',LastName='$Prenom',Gender='$Sexe',Etablissement='$Etablissement',Address='$Adresse',Encadreur='$Encadreur',Phonenumber='$Telephone' where IdStagaire='$did'");
    $msg="Stagaire est modifié";
}
 ?>
<!doctype html>
...
<body>
                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1><strong>Modifier</strong> Stagaire</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Modifier Stagaire</strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
                                           ...
                                           <?php    
                               $did=$_GET['empid'];
                               $res=mysqli_query($con,"SELECT * from  stagaires where IdStagaire='$did'");
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?php echo $row["Encadreur"] ?>" name="Encadreur" type="text" class="form-control cc-exp" autocomplete="off">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input value="<?php echo $row["Etablissement"] ?>" name="Etablissement" type="tel" class="form-control cc-cvc" value="" data-val="true"  autocomplete="off">
