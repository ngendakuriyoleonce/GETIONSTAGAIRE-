...
$totestagaires=0;
$res=mysqli_query($con,"select IdStagaire FROM `stagaires`");
$totestagaires=mysqli_num_rows($res);
...
$totad=0;
$res=mysqli_query($con,"select IdStagaire FROM `stagaires` where Role=1");
$totad=mysqli_num_rows($res);
                                ...
                                <div class="stat-widget-four">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-heading">Stagaires</div>
                                            <div class="stat-text">Total: <?php echo $totestagaires;?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="stat-widget-four">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-text">Total: <?php echo $totad;?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title"><strong>Demandes</strong> Recents </h4>
                                </div>
                                <div class="card-body--">
                                ...
                                $res=mysqli_query($con,"SELECT stages.IdStage  as lid, stagaires.FirstName, stagaires.LastName, stagaires.IdStagaire,stages.IdStagaire,tbldepartments.DepartmentName,stages.PostingDate,stages.Status,tbldepartments.IdDep,stages.Service  from stages join stagaires on stages.IdStagaire=stagaires.IdStagaire join tbldepartments on stages.Service=tbldepartments.IdDep order by lid desc limit 6");
                            $cnt=1;
